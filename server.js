...
export var $7f177b3d = $$m({
  "bun-framework-next/server.development.tsx": (module, exports) => {
    ...
    var $$7353f888 = $7353f888(), packagejson = (($$7353f888 && "default" in $$7353f888) ? $$7353f888.default : $$7353f888);
    const version = packagejson.version;
    if (!version.startsWith("11.1") && !version.startsWith("12.0") && !version.startsWith("12.1") || version === "11.1.0" || version === "11.1.1")
      console.warn("Possibly incompatible Next.js version: ", version, ". Please upgrade to Next.js 11.1.2 or Next.js 12.0.2+.\n");
    let buildId = 0;
    let DocumentLoaded = false;
    let DocumentNamespace;
    import(Bun.routesDir + "_document").then((doc) => {
...
export var $28cc2fda = $$m({
  "bun-framework-next/server-polyfills.tsx": (module, exports) => {
    ...
    if (!("URL" in globalThis)) {
      ...
      throw new Outdated("Missing \"URL\", please run 'bun upgrade' to update to the latest version of Bun (added in v0.0.74)");
    }
  }
}["bun-framework-next/server-polyfills.tsx"]);
...
export var $d8aafe0d = $$m({
  "@googlemaps/js-api-loader/dist/index.esm.js": (module, exports) => {
    ...
    __export(module.exports, { DEFAULT_ID: () => DEFAULT_ID,Loader: () => Loader,LoaderStatus: () => LoaderStatus});
  }
}["@googlemaps/js-api-loader/dist/index.esm.js"]);
...
export var $8fe7b146 = $$m({
  "bun-framework-next/renderDocument.tsx": (module, exports) => {
    var JSX = $74af56c6();
    var jsx = JSX.jsxDEV;
    var $$f3f4e1d6 = $f3f4e1d6(), App = (($$f3f4e1d6 && "default" in $$f3f4e1d6) ? $$f3f4e1d6.default : $$f3f4e1d6);
    var $$d3ff0f54 = $d3ff0f54();
    var $$db29be3a = $db29be3a();
    var $$6c2a3c6b = $6c2a3c6b(), Loadable = (($$6c2a3c6b && "default" in $$6c2a3c6b) ? $$6c2a3c6b.default : $$6c2a3c6b);
    ...
    function appendNextBody(documentHTML, pageContent) {
      if (nextVersion.startsWith("12.0")) {
        ...
        return documentHTML.substring(0, bodyRenderIdx) + pageContent + documentHTML.substring(bodyRenderIdx + NEXT_12_0_BODY_RENDER_TARGET.length);
      } else {
        var [renderTargetPrefix, renderTargetSuffix] = documentHTML.split("<next-js-internal-body-render-target></next-js-internal-body-render-target>");
        if (!renderTargetPrefix || !renderTargetSuffix)
          throw new Error("Can't find where your <App /> starts or where the <Document /> ends. \nThis is probably a version incompatibility. Please mention this error in Bun's discord\n\n" + documentHTML);
    ...
    const dev = true;
    const isJSFile = (file) => file.endsWith(".js") || file.endsWith(".jsx") || file.endsWith(".mjs") || file.endsWith(".ts") || file.endsWith(".tsx");
    ...
    function renderDocument(Document, {
      ...
      return ReactDOMServer.renderToStaticMarkup(jsx($$d3ff0f54.AmpStateContext.Provider, {
        value: ampState,
        children: jsx(HtmlContext.Provider, {
          value: htmlProps,
          children: jsx(Document, {
            ...htmlProps,
            ...docProps
          }, undefined, false, undefined, this)
        }, undefined, false, undefined, this)
    ...
    async function render({
      ...
      if (!ReactIs.isValidElementType(Component)) {
        ...
        if (reactComponents.length > 2)
          throw new Error(`\"export default\" missing in ${route.filePath}.\nTry exporting one of ${reactComponents.join(", ")}\n`);
        else if (reactComponents.length === 2)
          throw new Error(`\"export default\" missing in ${route.filePath}.\n\nTry exporting <${reactComponents[0]} /> or <${reactComponents[1]} />\n`);
        else if (reactComponents.length == 1)
          throw new Error(`\"export default\" missing in ${route.filePath}. Try adding this to the bottom of the file:\n\n        export default ${reactComponents[0]};\n`);
        else if (reactComponents.length == 0)
          throw new Error(`\"export default\" missing in ${route.filePath}. Try exporting a React component.\n`);
      }
      ...
      var scriptLoader = {};
      const AppContainer = ({ children }) => jsx($$d53ca603.RouterContext.Provider, {
        value: router,
        children: jsx($$db29be3a.HeadManagerContext.Provider, {
          value: {
            updateHead: (state) => {
              head = state;
            },
          ...
          children: jsx($$c4530628.LoadableContext.Provider, {
      ...
      const router = new ServerRouter(pathname, query, asPath, {
        isFallback
      }, true, origin, null, [], null, [], false, false);
      const ctx = {
        err: null,
        req: undefined,
        res: undefined,
      ...
      const renderPage = (options = {}) => {
        if (ctx.err && ErrorDebug) {
          const htmlOrPromise = renderToString(jsx(ErrorDebug, {
            error: ctx.err
          }, undefined, false, undefined, this));
        ...
        const { App: EnhancedApp, Component: EnhancedComponent } = enhanceComponents(options, AppComponent, Component);
        const htmlOrPromise = renderToString(jsx(AppContainer, {
          children: jsx(EnhancedApp, {
      ...
      if (!docProps || typeof docProps.html !== "string") {
        const message = `"${$$8496d550.getDisplayName(Document)}.getInitialProps()" should resolve to an object with a "html" prop set with a valid html string`;
        throw new Error(message);
      }
      const renderOpts = {
        params: route.params
    ...
    Object.defineProperty(module.exports,"render",{get: () => render, enumerable: true, configurable: true});
    function useMaybeDeferContent(_name, contentFn) {
      return [false, contentFn()];
    }
    Object.defineProperty(module.exports,"useMaybeDeferContent",{get: () => useMaybeDeferContent, enumerable: true, configurable: true});
  }
}["bun-framework-next/renderDocument.tsx"]);
  ...
  "buffer/index.js": (module, exports) => {
    ...
    var C = (i, r, t, n) => {
      if (r && typeof r == "object" || typeof r == "function")
        for (let e of Er(r))
          !gr.call(i, e) && (t || e !== "default") && D(i, e, { get: () => r[e], enumerable: !(n = Br(r, e)) || n.enumerable });
      return i;
    };
    var mr = (i, r) => C(X(D(i != null ? xr(dr(i)) : {}, "default", !r && i && i.__esModule ? { get: () => i.default, enumerable: true } : { value: i, enumerable: true })), i);
    var Ir = ((i) => (r, t) => i && i.get(r) || (t = C(X({}), r, 1), i && i.set(r, t), t))(typeof WeakMap != "undefined" ? new WeakMap : 0);
    var K = $((_) => {
      ;
      _.byteLength = Ar;
      _.toByteArray = Rr;
      _.fromByteArray = Sr;
      var B = [], w = [], Fr = typeof Uint8Array != "undefined" ? Uint8Array : Array, b = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
      ...
      function Rr(i) {
        var r, t = J(i), n = t[0], e = t[1], o = new Fr(Ur(i, n, e)), u = 0, f = e > 0 ? n - 4 : n, c;
        for (c = 0;c < f; c += 4)
    ...
    var Z = $((P) => {
      ...
      P.write = function(i, r, t, n, e, o) {
        var u, f, c, l = o * 8 - e - 1, s = (1 << l) - 1, p = s >> 1, F = e === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, x = n ? 0 : o - 1, k = n ? 1 : -1, wr = r < 0 || r === 0 && 1 / r < 0 ? 1 : 0;
    ...
    var yr = $((T) => {
      ;
      var O = K(), A = Z(), Q = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
      T.Buffer = h;
      T.SlowBuffer = Dr;
      ...
      function Lr(i, r, t) {
        return rr(i), i <= 0 ? d(i) : r !== undefined ? typeof t == "string" ? d(i).fill(r, t) : d(i).fill(r) : d(i);
      }
      ...
      function Nr(i, r) {
        ...
        let t = tr(i, r) | 0, n = d(t), e = n.write(i, r);
        return e !== t && (n = n.slice(0, e)), n;
      }
      function Y(i) {
        let r = i.length < 0 ? 0 : W(i.length) | 0, t = d(r);
        for (let n = 0;n < r; n += 1)
          t[n] = i[n] & 255;
        return t;
      }
      ...
      function kr(i) {
        if (h.isBuffer(i)) {
          let r = W(i.length) | 0, t = d(r);
          return t.length === 0 || i.copy(t, 0, 0, r), t;
        }
        if (i.length !== undefined)
          return typeof i.length != "number" || V(i.length) ? d(0) : Y(i);
      ...
      function ir(i, r, t, n, e) {
        ...
        if (typeof r == "number")
          return r = r & 255 , typeof Uint8Array.prototype.indexOf == "function" ? e ? Uint8Array.prototype.indexOf.call(i, r, t) : Uint8Array.prototype.lastIndexOf.call(i, r, t) : nr(i, [r], t, n, e);
      ...
      function Wr(i) {
        ...
        let t = "", n = 0;
        for (;n < r; )
          t += String.fromCharCode.apply(String, i.slice(n, n += or));
        return t;
      }
      function jr(i, r, t) {
        let n = "";
      ...
      function cr(i, r, t, n, e) {
        return r = +r , t = t >>> 0 , e || fr(i, r, t, 4, 340282346638528860000000000000000000000, -340282346638528860000000000000000000000), A.write(i, r, t, n, 23, 4), t + 4;
      }
      ...
      function pr(i, r, t, n, e) {
        return r = +r , t = t >>> 0 , e || fr(i, r, t, 8, , -), A.write(i, r, t, n, 52, 8), t + 8;
      }
      ...
      j("ERR_BUFFER_OUT_OF_BOUNDS", function(i) {
        return i ? `${i} is outside of buffer bounds` : "Attempt to access memory outside buffer bounds";
      }, RangeError);
      j("ERR_INVALID_ARG_TYPE", function(i, r) {
        return `The "${i}" argument must be of type number. Received type ${typeof r}`;
      }, TypeError);
      j("ERR_OUT_OF_RANGE", function(i, r, t) {
        let n = `The value of "${i}" is out of range.`, e = t;
        return Number.isInteger(t) && Math.abs(t) > 2 ** 32 ? e = sr(String(t)) : typeof t == "bigint" && (e = String(t), (t > BigInt(2) ** BigInt(32) || t < -(BigInt(2) ** BigInt(32))) && (e = sr(e)), e += "n"), n += ` It must be ${r}. Received ${e}`, n;
      }, RangeError);
      function sr(i) {
      ...
      function S(i, r, t) {
        throw Math.floor(i) !== i ? (R(i, t), new U.ERR_OUT_OF_RANGE(t || "offset", "an integer", i)) : r < 0 ? new U.ERR_BUFFER_OUT_OF_BOUNDS : new U.ERR_OUT_OF_RANGE(t || "offset", `>= ${t ? 1 : 0} and <= ${r}`, i);
      }
      var Jr = /[^+/0-9A-Za-z-_]/g;
      function Kr(i) {
        if (i = i.split("=")[0], i = i.trim().replace(Jr, ""), i.length < 2)
          return "";
        for (;i.length % 4 !== 0; )
          i = i + "=";
        return i;
  ...
  "next/dist/compiled/use-subscription/index.js": (module, exports) => {
    ...
    (() => {
      ...
      var e = { 800: (e) => {
        ...
        e.exports = shouldUseNative() ? Object.assign : function(e, n) {
          var a;
          var i = toObject(e);
          var s;
        ...
        (function() {
          ...
          function useSubscription(r) {
            var t = r.getCurrentValue, n = r.subscribe;
            ...
            u.useEffect(function() {
              ...
              var checkForUpdates = function() {
                ...
                var u = t();
                s(function(r) {
                  if (r.getCurrentValue !== t || r.subscribe !== n)
                    return r;
                  if (r.value === u)
                    return r;
                  return e({}, r, { value: u });
        ...
        r.useSubscription = function(e) {
          var r = e.getCurrentValue, t = e.subscribe, a = n.useState(function() {
          ...
          n.useEffect(function() {
            function b() {
              if (!e) {
                var n = r();
                i(function(e) {
                  return e.getCurrentValue !== r || e.subscribe !== t || e.value === n ? e : u({}, e, { value: n });
                });
              }
            }
            var e = false, n = t(b);
...
export var $65e0d031 = $$m({
  "next/dist/pages/_document.js": (module, exports) => {
    ...
    function getPolyfillScripts(context, props) {
      ...
      return buildManifest.polyfillFiles.filter((polyfill) => polyfill.endsWith(".js") && !polyfill.endsWith(".module.js")).map((polyfill) => _react.default.createElement("script", {
        key: polyfill,
    ...
    function getPreNextWorkerScripts(context, props) {
      ...
      if (!nextScriptWorkers)
        return null;
      try {
        let { partytownSnippet } = (() => { throw (new Error(`Cannot require module "@builder.io/partytown/integration"`)); } )();
        const children = Array.isArray(props.children) ? props.children : [
          props.children
        ];
        const userDefinedConfig = children.find((child) => {
          var ref, ref1;
          return hasComponentProps(child) && (child === null || child === undefined ? undefined : (ref = child.props) === null || ref === undefined ? undefined : (ref1 = ref.dangerouslySetInnerHTML) === null || ref1 === undefined ? undefined : ref1.__html.length) && ("data-partytown-config" in child.props);
        });
        return _react.default.createElement(_react.default.Fragment, null, !userDefinedConfig && _react.default.createElement("script", {
          ...
          return _react.default.createElement("script", Object.assign({}, scriptProps, {
            type: "text/partytown",
    ...
    function getPreNextScripts(context, props) {
      ...
      const beforeInteractiveScripts = (scriptLoader.beforeInteractive || []).map((file, index) => {
        ...
        return _react.default.createElement("script", Object.assign({}, scriptProps, {
          key: scriptProps.src || index,
          defer: (_defer = scriptProps.defer) !== null && _defer !== undefined ? _defer : !disableOptimizedLoading,
          nonce: props.nonce,
          "data-nscript": "beforeInteractive",
          crossOrigin: props.crossOrigin || crossOrigin
        }));
      });
      return _react.default.createElement(_react.default.Fragment, null, webWorkerScripts, beforeInteractiveScripts);
    }
    ...
    function getScripts(context, props, files) {
      ...
      const lowPriorityScripts = (ref = buildManifest.lowPriorityFiles) === null || ref === undefined ? undefined : ref.filter((file) => file.endsWith(".js"));
      return [
        ...normalScripts,
        ...lowPriorityScripts
      ].map((file) => {
    ...
    function Html(props) {
      ...
      return _react.default.createElement("html", Object.assign({}, props, {
    ...
    function AmpStyles({ styles }) {
      ...
      if (styles.props && Array.isArray(styles.props.children)) {
        const hasStyles = (el) => {
          var ref, ref2;
          return el === null || el === undefined ? undefined : (ref = el.props) === null || ref === undefined ? undefined : (ref2 = ref.dangerouslySetInnerHTML) === null || ref2 === undefined ? undefined : ref2.__html;
        };
    ...
    class Head extends _react.Component {
      ...
      getPreloadMainLinks(files) {
        ...
        return [
          ...(scriptLoader.beforeInteractive || []).map((file) => _react.default.createElement("link", {
            key: file.src,
            nonce: this.props.nonce,
            rel: "preload",
            href: file.src,
          ...
          ...preloadFiles.map((file) => _react.default.createElement("link", {
            key: file,
            nonce: this.props.nonce,
            rel: "preload",
            href: `${assetPrefix}/_next/${encodeURI(file)}${devOnlyCacheBusterQueryString}`,
      ...
      makeStylesheetInert(node) {
        return _react.default.Children.map(node, (c) => {
          var ref5, ref3;
          if ((c === null || c === undefined ? undefined : c.type) === "link" && (c === null || c === undefined ? undefined : (ref5 = c.props) === null || ref5 === undefined ? undefined : ref5.href) && _constants.OPTIMIZED_FONT_PROVIDERS.some(({ url }) => {
            var ref, ref4;
            return c === null || c === undefined ? undefined : (ref = c.props) === null || ref === undefined ? undefined : (ref4 = ref.href) === null || ref4 === undefined ? undefined : ref4.startsWith(url);
          })) {
            const newProps = {
              ...c.props || {},
          ...
          } else if (c === null || c === undefined ? undefined : (ref3 = c.props) === null || ref3 === undefined ? undefined : ref3.children) {
            const newProps = {
              ...c.props || {},
      ...
      render() {
        ...
        children = _react.default.Children.map(children, (child) => {
          var ref;
          const isReactHelmet = child === null || child === undefined ? undefined : (ref = child.props) === null || ref === undefined ? undefined : ref["data-react-helmet"];
          if (!isReactHelmet) {
            var ref6;
            if ((child === null || child === undefined ? undefined : child.type) === "title")
              console.warn("Warning: <title> should not be used in _document.js's <Head>. https://nextjs.org/docs/messages/no-document-title");
            else if ((child === null || child === undefined ? undefined : child.type) === "meta" && (child === null || child === undefined ? undefined : (ref6 = child.props) === null || ref6 === undefined ? undefined : ref6.name) === "viewport")
        ...
        var _nonce, _nonce1;
        return _react.default.createElement("head", Object.assign({}, this.props), this.context.isDevelopment && _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("style", {
        ...
        }))), head, _react.default.createElement("meta", {
          name: "next-head-count",
          content: _react.default.Children.count(head || []).toString()
        }), children, optimizeFonts && _react.default.createElement("meta", {
        ...
        }), !optimizeCss && this.getCssLinks(files), !optimizeCss && _react.default.createElement("noscript", {
          "data-n-css": (_nonce = this.props.nonce) !== null && _nonce !== undefined ? _nonce : ""
        }), !disableRuntimeJS && !disableJsPreload && this.getPreloadDynamicChunks(), !disableRuntimeJS && !disableJsPreload && this.getPreloadMainLinks(files), !disableOptimizedLoading && !disableRuntimeJS && this.getPolyfillScripts(), !disableOptimizedLoading && !disableRuntimeJS && this.getPreNextScripts(), !disableOptimizedLoading && !disableRuntimeJS && this.getDynamicChunks(files), !disableOptimizedLoading && !disableRuntimeJS && this.getScripts(files), optimizeCss && this.getCssLinks(files), optimizeCss && _react.default.createElement("noscript", {
          "data-n-css": (_nonce1 = this.props.nonce) !== null && _nonce1 !== undefined ? _nonce1 : ""
        }), this.context.isDevelopment && _react.default.createElement("noscript", {
    ...
    class NextScript extends _react.Component {
      ...
      render() {
        ...
        if (inAmpMode) {
          ...
          return _react.default.createElement(_react.default.Fragment, null, disableRuntimeJS ? null : _react.default.createElement("script", {
            id: "__NEXT_DATA__",
          ...
          }), ampDevFiles.map((file) => _react.default.createElement("script", {
            key: file,
        ...
        const files = getDocumentFiles(this.context.buildManifest, this.context.__NEXT_DATA__.page, inAmpMode);
        return _react.default.createElement(_react.default.Fragment, null, !disableRuntimeJS && buildManifest.devFiles ? buildManifest.devFiles.map((file) => _react.default.createElement("script", {
          key: file,
          src: `${assetPrefix}/_next/${encodeURI(file)}${devOnlyCacheBusterQueryString}`,
          nonce: this.props.nonce,
          crossOrigin: this.props.crossOrigin || crossOrigin
        })) : null, disableRuntimeJS ? null : _react.default.createElement("script", {
          id: "__NEXT_DATA__",
          type: "application/json",
          nonce: this.props.nonce,
          crossOrigin: this.props.crossOrigin || crossOrigin,
...
export var $64a4b1ba = $$m({
  "next/dist/client/head-manager.js": (module, exports) => {
    ...
    function updateElements(type, components) {
      ...
      const oldTags = [];
      for (let i = 0, j = headCountEl.previousElementSibling;i < headCount; i++, j = (j === null || j === undefined ? undefined : j.previousElementSibling) || null) {
        var ref;
        if ((j === null || j === undefined ? undefined : (ref = j.tagName) === null || ref === undefined ? undefined : ref.toLowerCase()) === type)
          oldTags.push(j);
      }
